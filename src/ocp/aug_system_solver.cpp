                                                  ...
                                                  VecRealView* D_s)
{
    ...
    for (int k = 0; k < K-1; ++k){
        ...
        if (k < K - 2){
            ...
            gemm_nt(nx_next_next, nx_next - rank, rank, 1.0, hessian.FuFx[k+1], nu_next, 0, jacobian.U1U2t[k], 0, 0, 1.0, 
                    hessian.FuFx[k+1], nu_next, rank, hessian.FuFx[k+1], nu_next, rank);
        }
