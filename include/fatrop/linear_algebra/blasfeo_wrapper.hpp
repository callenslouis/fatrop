...
namespace fatrop
{
    ...
    static inline void blasfeo_trsm_runn_wrap(int m, int n, Scalar alpha, const MAT *sA, int ai,
                                              int aj, const MAT *sB, int bi, int bj, MAT *sD,
                                              int di, int dj)
    {
        fatrop_dbg_assert(m >= 0 && n >= 0 && "Matrix dimensions must be positive");
        ...
        fatrop_dbg_assert(ai + n <= sA->m && aj + n <= sA->n && bi + m <= sB->m &&
                          bj + n <= sB->n && di + m <= sD->m && dj + n <= sD->n &&
                          "Submatrices must fit within matrix dimensions");
        TRSM_RUNN(m, n, alpha, const_cast<MAT *>(sA), ai, aj, const_cast<MAT *>(sB), bi, bj, sD, di,
                  dj);
    }

    static inline void blasfeo_trsm_rlnu_wrap(int m, int n, Scalar alpha, const MAT *sA, int ai,
                                              int aj, const MAT *sB, int bi, int bj, MAT *sD,
                                              int di, int dj)
    {
        fatrop_dbg_assert(m >= 0 && n >= 0 && "Matrix dimensions must be positive");
    ...
    static inline void blasfeo_trsm_runu_wrap(int m, int n, Scalar alpha, const MAT *sA, int ai,
                                              int aj, const MAT *sB, int bi, int bj, MAT *sD,
                                              int di, int dj)
    {
        fatrop_dbg_assert(m >= 0 && n >= 0 && "Matrix dimensions must be positive");
    ...
    static inline void blasfeo_trsm_llnu_wrap(int m, int n, Scalar alpha, const MAT *sA, int ai,
                                              int aj, const MAT *sB, int bi, int bj, MAT *sD,
                                              int di, int dj)
    {
        fatrop_dbg_assert(m >= 0 && n >= 0 && "Matrix dimensions must be positive");
    ...
    static inline void blasfeo_gemm_nn_wrap(int m, int n, int k, Scalar alpha, const MAT *sA,
                                            int ai, int aj, const MAT *sB, int bi, int bj,
                                            Scalar beta, const MAT *sC, int ci, int cj, MAT *sD,
                                            int di, int dj)
    {
    ...
    static inline void blasfeo_gemm_tn_wrap(int m, int n, int k, Scalar alpha, const MAT *sA, int ai, int aj, const MAT *sB,
                                            int bi, int bj, Scalar beta, const MAT *sC, int ci, int cj,
    ...
    static inline void blasfeo_gemm_tt_wrap(int m, int n, int k, Scalar alpha, const MAT *sA, int ai, int aj, const MAT *sB,
                                            int bi, int bj, Scalar beta, const MAT *sC, int ci, int cj,
                                            MAT *sD, int di, int dj)
    {
        fatrop_dbg_assert(m >= 0 && n >= 0 && k >= 0 && "Matrix dimensions must be positive");
        ...
        fatrop_dbg_assert(ai + m <= sA->m && aj + k <= sA->n && bi + n <= sB->m &&
                          ...
                          di + m <= sD->m && dj + n <= sD->n &&
                          "Submatrices must fit within matrix dimensions");
        GEMM_TT(m, n, k, alpha, const_cast<MAT *>(sA), ai, aj, const_cast<MAT *>(sB), bi, bj, beta,
                const_cast<MAT *>(sC), ci, cj, sD, di, dj);
    }
