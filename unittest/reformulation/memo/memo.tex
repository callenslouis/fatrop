...
\begin{align}
    ...
    & &\text{such that} &
    \tilde{L}^{-1} &= \begin{bmatrix} K_1^{-1} & & \\ -K_2 K_1^{-1} & \bm{I}_{n_u-\rho} & \\ & & \bm{I}_{n_x} \end{bmatrix}
\end{align}
which leads to
\begin{equation}
    \tilde{L}^{-1} 
...
\begin{equation}
    \tilde{P} \coloneqq \begin{bmatrix} \bm{I}_\rho & & \\ & & \bm{I}_{n_g-\rho}\\ & \bm{I}_{n_x} & \end{bmatrix}
\end{equation}
leading to
\begin{equation}
    \tilde{P}
