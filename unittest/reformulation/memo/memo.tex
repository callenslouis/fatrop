...
\begin{align}
    ...
    \label{eq:Hu-upper}
\end{align}
where $M_1 \in \mathbb{R}^{n_f \times n_x}$, $M_2 \in \mathbb{R}^{n_f \times n_u}$, and $M_3 \in \mathbb{R}^{n_g \times n_u}$.
...
\begin{equation}
    ...
    \end{bNiceMatrix}
\end{equation}
where $\begin{bmatrix} (\tilde{M}_2)_1 &(\tilde{M}_2)_2 \end{bmatrix} = M_2 Q_1$ with $(\tilde{M}_2)_1 \in \mathbb{R}^{n_f \times \rho}$ and $(\tilde{M}_2)_2 \in \mathbb{R}^{n_f \times n_x - \rho}$.
